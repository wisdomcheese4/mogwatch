...
REM Force the working directory to wherever this .bat file actually lives.
REM Without this, "Run as administrator" can launch the script with its
REM working directory set to System32 instead, making every relative file
REM check below (mogwatch_viewer.py, mogwatch.ico) fail even when those
REM files are sitting right next to this script.
cd /d "%~dp0"
